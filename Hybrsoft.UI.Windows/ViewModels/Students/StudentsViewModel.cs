...
namespace Hybrsoft.UI.Windows.ViewModels
{
	public partial class StudentsViewModel : ViewModelBase
	{
		...
		private async Task PopulateDetails(StudentModel selected)
		{
			try
			{
				var model = await _studentService.GetStudentAsync(selected.StudentID);
		...
		private async Task PopulateStudentRelatives(StudentModel selectedItem)
		{
			try
			{
