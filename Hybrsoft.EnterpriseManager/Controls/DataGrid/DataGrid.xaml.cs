...
public sealed partial class DataGrid : UserControl, INotifyExpressionChanged
{
	...
	public static readonly DependencyProperty DefaultCommandsMultipleSelectionProperty = DependencyProperty.Register(nameof(DefaultCommandsMultipleSelection), typeof(string), typeof(DataGrid), new PropertyMetadata("cancel,delete"));
	#endregion
	...
	public static readonly DependencyProperty AcceptCommandProperty = DependencyProperty.Register(nameof(AcceptCommand), typeof(ICommand), typeof(DataGrid), new PropertyMetadata(null));
	#endregion
	...
	private void OnToolbarClick(object sender, ToolbarButtonClickEventArgs e)
	{
		switch (e.ClickedButton)
		{
			...
			case ToolbarButton.Delete:
				...
				break;
			case ToolbarButton.Accept:
				AcceptCommand?.TryExecute();
				break;
